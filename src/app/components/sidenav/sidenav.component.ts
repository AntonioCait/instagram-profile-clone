...
export class SidenavComponent {
  ...
  sideBarIcons: IInstagramIcons[] = [
    ...
    {
      name: 'Profile',
      svgPath: '<svg aria-label="Profile" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Profile</title><path clip-rule="evenodd" d="M12 12a4 4 0 1 1 0-8 4 4 0 0 1 0 8Zm0 2c2.67 0 8 1.34 8 4v2H4v-2c0-2.66 5.33-4 8-4Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg>',
      path: '/profile'
    }
  ]
